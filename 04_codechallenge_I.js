...
let erste_zahl = prompt("Erste Zahl "); // bei einem Prompt immer Text eingeben der Augegeben werden soll 
let zweite_zahl = prompt("Zweite Zahl ");// das gleiche hier auch 
erste_zahl = parseInt(erste_zahl); // Der Prompt den man eingibt wird in eine Zahl umgwandelt mit parseInt
zweite_zahl = parseInt(zweite_zahl);// das gleiche mit der zweiten Zahl
summe = erste_zahl + zweite_zahl;// Die Eingegebenen Zahlen werden zusammen gezählt 
console.log("Ergebnis = " + summe);// Ausgabe des Ergebnis


//Andere arten wie man diese Aufgabe lösen tut
